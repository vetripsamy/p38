...
function setup() {
  ...
  trex = createSprite(50,displayHeight-210,20,50);
  ...
  gameOver = createSprite(camera.x,displayHeight/2-150);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(camera.x,displayHeight/2-40);
  ...
  invisibleGround = createSprite(displayWidth/2,displayHeight-190,displayWidth,10);
